...
func HttpResult(r *http.Request, w http.ResponseWriter, resp interface{}, err error) {
	...
	if err == nil {
		...
		//错误返回
		errcode := errx.InternalServerError
...
func ParamErrorResult(r *http.Request, w http.ResponseWriter, err error) {
	errMsg := fmt.Sprintf("%s ,%s", errx.MapErrMsg(errx.RequestParamError), err.Error())
	httpx.WriteJson(w, http.StatusBadRequest, Error(errx.RequestParamError, errMsg))
}
